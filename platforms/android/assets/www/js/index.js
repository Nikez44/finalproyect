                ...
                var element = $('<div data-role="collapsible" data-inset="false" class="ui-collapsible ui-collapsible-themed-content ui-collapsible-collapsed">' +
                                    ...
                                    '<div class="ui-collapsible-content ui-body-inherit ui-collapsible-content-collapsed" aria-hidden="true">' +
                                        '<ul data-role="listview" class="ui-listview">' +
                                            '<li class="ui-first-child"><a href="#" class="ui-btn ui-btn-icon-right ui-icon-carat-r waves-effect waves-button waves-effect waves-button waves-effect waves-button">Lugar 1</a></li>' +
                                        '</ul>' +
                                    '</div>' +
                                '</div>');
